...
image_files = [f for f in glob.glob(r"C:\Users\victo\Desktop\aaa\Gender-Detection\gender_dataset_face" + "/**/*", recursive=True) if not os.path.isdir(f)]
...
model.save('gender_detection.model', save_format='h5')
